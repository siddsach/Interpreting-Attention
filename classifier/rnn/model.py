...
class SelfAttentiveRNN(VanillaRNN):
    ...
    def __init__(
            ...
            attention_dim,
            mlp_hidden,
            num_aspects = None, #IF WE ONLY CONSIDER ONE ASPECT, IGNORE THIS ARG
            **kwargs
        ):
        ...
        self.MLP = nn.Linear(num_aspects * self.hidden_size * 2, mlp_hidden)
    ...
    def forward(self, inp, h, lens):
        ...
        Batched_Attentions = Variable(torch.zeros(input.size(0), self.num_aspects * self.input_hidden_size).cuda())
