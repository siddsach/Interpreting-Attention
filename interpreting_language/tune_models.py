...
best = {}
for dataset in ['ptb', 'wikitext']:
    best[dataset] = {}

    best_params, best_loss = optimize(dataset)

    best[dataset]['params'] = best_params
    best[dataset]['loss'] = best_loss

pickle.dump(best, open('params.pickle', 'wb'))
